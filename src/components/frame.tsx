...
import frameImage1 from "@/assets/frame-image-1.png";
import frameImage2 from "@/assets/frame-image-2.png";
...
const Frame = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="#F9F9F9" d="M0 0h138v180H0z" />
    <g clipPath="url(#a)">
      <g filter="url(#b)">
        <mask id="f" fill="#fff">
    ...
    <defs>
      ...
      >
        ...
        <feMorphology
          ...
          operator="dilate"
          radius={2}
          result="effect1_dropShadow_1127_4634"
        />
        <feOffset dy={4} />
        ...
        <feBlend
          in="SourceGraphic"
          in2="effect1_dropShadow_1127_4634"
          result="shape"
        />
      </filter>
      <filter
      ...
      >
        <use xlinkHref="#s" transform="matrix(.00177 0 0 .00136 -.152 0)" />
      </pattern>
      <pattern
        id="h"
        width={1}
        ...
        patternContentUnits="objectBoundingBox"
      >
        <use xlinkHref="#t" transform="matrix(.0018 0 0 .00136 -.16 0)" />
      </pattern>
      <pattern
        id="l"
        width={1}
        ...
        patternContentUnits="objectBoundingBox"
      >
        <use xlinkHref="#t" transform="matrix(.0018 0 0 .00136 -.163 0)" />
      </pattern>
      <image id="s" xlinkHref={frameImage1.src} width={736} height={736} />
      <image id="t" xlinkHref={frameImage2.src} width={736} height={736} />
      <clipPath id="a">
